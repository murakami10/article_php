...
if($count_sql == 0)
{
	$sql = "insert into favorite(favorite_id, favorite_article_id, favorite_user_id) values(:favorite_id, :favorite_article_id, :favorite_user_id)";
	$stmt_insert = $pdo->prepare($sql);
	$stmt_insert->bindValue(':favorite_id',null,PDO::PARAM_NULL);
